...
On the other hand, strings and lists are different because they
are made up of smaller pieces.  In the case of strings, they are made up of smaller
strings each containing one **character**.  

Types that are comprised of smaller pieces are called **collection data types** and are sometimes referred to informally as sequences.
...
examine some special functions that are defined only for strings, and we'll find out one important
